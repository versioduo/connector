...
#if !defined(CYPM1311_48LQXI)
#error "Unexpected MPN; expected DEVICE:=CYPM1311-48LQXI. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYPM1311_48LQXI) */
